...
<div class="w3-bar w3-white w3-large">
  ...
  <a href="allrequests.jsp" class="w3-bar-item w3-button w3-blue w3-mobile">Tous les demandes</a>
			...
			<div class="w3-row-padding w3-padding-16">
					...
					try {
						...
						while (resultSet.next()) {
							...
							if(Countrow.equals("0")){
								...
								<button type="submit" class="btn danger" style="margin: 20px">Supprimer tout</button>
								</form>
								<%
							}
						}
				...
				<div class="w3-third w3-margin-bottom">
					<div class="w3-container w3-white">
						...
						<ul>
							<li>Adultes : <b><%=resultSet.getString("Adults")%></b></li>
							<li>Enfants : <b><%=resultSet.getString("Kids")%></b></li>
							<li>Date d'arrivée : <b><%=resultSet.getString("CheckIn")%></b></li>
							<li>Date de départ : <b><%=resultSet.getString("CheckOut")%></b></li>
							<li>Demandé par : <b><%=resultSet.getString("RequestMadeBy")%></b></li>
						</ul>
						...
						<table>
							<tr>
								...
								%>
								<td>
									<p class="ConfirmedLbl">Confirmé</p>
								</td>
								<%
									} else {
								%>
								...
								<td>
									<form action="../ConfirmRoomByOwner" method="post">
										<input type="number" value="" name="room_number"
											placeholder="Numéro de chambre" required="required"> <input											style="display: none;" type="text" name="req_id"
