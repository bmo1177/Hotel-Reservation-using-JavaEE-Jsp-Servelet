...
<div class="w3-bar w3-white w3-large">
  ...
  <a href="myrequests.jsp" class="w3-bar-item w3-button w3-blue w3-mobile">Mes demandes</a>
                ...
                try {
                    ...
                    while (resultSet.next()) {
                        ...
                        if(Countrow.equals("0")){
                            ...
                            <a href="home.jsp" class="Alink">Faire une demande</a></center>
                            </div>
                ...
                <div class="w3-container w3-white">
                    ...
                    %>
                        ...
                        <button type="submit" class="btn success" id="save_btn_<%=resultSet.getString("id")%>" 
                            style="margin-left: 20px; margin-bottom: 20px; display: none;">Enregistrer</button>
                    </form>
