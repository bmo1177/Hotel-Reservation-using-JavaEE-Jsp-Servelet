...
<div class="w3-container w3-margin-top" id="rooms">
    <h3>Chambres</h3>
    <p>Faites-vous comme chez vous est notre slogan. Nous offrons les meilleurs lits de l'industrie. Dormez bien et reposez-vous bien.</p>
</div>

<div class="w3-row-padding w3-padding-16">
    <div class="w3-third w3-margin-bottom">
        <img src="../Images/roomsingle.jpg" alt="Norvège" style="width:100%">
        <div class="w3-container w3-white">
            <h3>Chambre simple</h3>
            <h6 class="w3-opacity">À partir de 2000DA</h6>
            <p>Lit simple</p>
            <p>15m<sup>2</sup></p>
    ...
    <div class="w3-third w3-margin-bottom">
        <img src="../Images/roomdouble.jpg" alt="Norvège" style="width:100%">
        <div class="w3-container w3-white">
            <h3>Chambre double</h3>
            <h6 class="w3-opacity">À partir de 4000DA</h6>
            <p>Lit queen-size</p>
            <p>25m<sup>2</sup></p>
    ...
    <div class="w3-third w3-margin-bottom">
        <img src="../Images/roomdeluxe.jpg" alt="Norvège" style="width:100%">
        <div class="w3-container w3-white">
            <h3>Chambre de luxe</h3>
            <h6 class="w3-opacity">À partir de 6000DA</h6>
            <p>Lit king-size</p>
            <p>40m<sup>2</sup></p>
